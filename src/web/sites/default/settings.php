 ...
 * @endcode
 */
$settings['hash_salt'] = 'jAXdUxgUsu5nuSp6ZUKp4cZfLH-5J8YJ0cqo1PEqeqETCSAWCQpcKvFDrIX8gKPXE7iIDfnkNw';
...
if (file_exists($app_root . '/' . $site_path . '/settings.aws.php') && getenv('OPENSHIFT_BUILD_NAME') != '') {
