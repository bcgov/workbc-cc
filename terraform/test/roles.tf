...
resource "aws_iam_role" "workbc_cc_container_role" {
  name = "workbc_cc_container_role"
...
resource "aws_iam_role_policy" "workbc_cc_container_cwlogs" {
...
resource "aws_iam_role_policy" "workbc_cc_container_efs" {
...
resource "aws_iam_role_policy" "workbc_cc_container_start_task" {
...
resource "aws_iam_role_policy" "workbc_cc_container_ssm" {
