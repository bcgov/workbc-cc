  ...
  container_definitions = jsonencode([
	{
		...
		networkMode = "awsvpc"
		entryPoint = ["sh",	"-c"]
		command = ["cp -rf /code/. /app; ln -s /contents/public /app/web/sites/default/files; ln -s /contents/private /app/private; ln -s /app/vendor/drush/drush/drush /usr/local/bin/drush;"]
		mountPoints = [
			{
